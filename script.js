// The structure for the trivia questions and results
/**
function generateQuiz(questions, quizContainer, resultsContainer, submitButton){

	function showQuestions(questions, quizContainer){
		// here is where the questions for the game go, the answer options and the correct answer will be displayed
        var myQuestions = [
            {
            ...
            {
                question: "How many kittens are in the average litter?",
                answers: {
                    a: '10',
                    b: '6',
                    c: '4'
